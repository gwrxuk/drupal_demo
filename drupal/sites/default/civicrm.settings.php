...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:demo1234@localhost/drupal?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:demo1234@localhost:3306/drupal?new_link=true');
  }
}
...
$civicrm_root = '/var/www/html/drupal_demo/drupal/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/html/drupal_demo/drupal/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://35.165.212.165/drupal_demo/drupal/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '067a71f00eee621e1323e39586a8dd75');
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/html/drupal_demo/drupal/sites/default/files/civicrm/templates_c//mail.log');
// }
